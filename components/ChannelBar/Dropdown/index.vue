<template>
  <div class='dropdown'>
    <div role="button" @click="expanded=!expanded" class="dropdown-header">
      ...
      <button class="ml-auto mr-2"
              type="button">
        <svg data-modal-toggle="createAddMember-modal"
             data-modal-target="createAddMember-modal"
      ...
      <svg id="dropdownLeftSettingButton" data-dropdown-toggle="dropdownLeftSetting" data-dropdown-placement="left"
          xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear my-auto"
           viewBox="0 0 16 16">
        <path
  ...
  <!-- Dropdown menu -->
  <div id="dropdownLeftSetting" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLeftSettingButton">
      <li>
        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Invite people</a>
      </li>
      <li>
        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit conversation</a>
      </li>
      <li>
        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Delete conversation</a>
      </li>
    </ul>
  </div>
</template>
